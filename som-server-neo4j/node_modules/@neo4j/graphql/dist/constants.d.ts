...
export declare const FIELD_DIRECTIVES: readonly ["alias", "authentication", "authorization", "coalesce", "customResolver", "cypher", "default", "filterable", "id", "jwtClaim", "populatedBy", "relationship", "relayId", "selectable", "settable", "subscriptionsAuthorization", "timestamp", "unique"];
export type FieldDirective = (typeof FIELD_DIRECTIVES)[number];
export declare const OBJECT_DIRECTIVES: readonly ["authentication", "authorization", "deprecated", "fulltext", "jwt", "mutation", "node", "plural", "query", "limit", "shareable", "subscription", "subscriptionsAuthorization"];
export type ObjectDirective = (typeof OBJECT_DIRECTIVES)[number];
export declare const INTERFACE_DIRECTIVES: readonly ["relationshipProperties", "query", "plural"];
export type InterfaceDirective = (typeof INTERFACE_DIRECTIVES)[number];
export declare const UNION_DIRECTIVES: readonly ["query", "plural"];
