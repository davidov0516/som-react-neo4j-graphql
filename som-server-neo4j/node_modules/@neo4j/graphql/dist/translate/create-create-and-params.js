...
function createCreateAndParams({ input, varName, node, context, callbackBucket, withVars, includeRelationshipValidation, topLevelNodeVariable, idx = 0, // used to build authorization variable in auth subqueries
