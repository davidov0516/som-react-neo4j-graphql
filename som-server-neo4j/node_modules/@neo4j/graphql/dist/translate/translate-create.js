...
async function translateCreate({ context, node, }) {
     ...
     **/
    const projectionClause = cypher_builder_1.default.concat(...(0, utils_1.filterTruthy)(varNameVariables.map((varName) => {
        ...
        if (queryASTResult.clauses.length) {
            ...
            const clause = cypher_builder_1.default.concat(...queryASTResult.clauses);
            return new cypher_builder_1.default.Call(clause).innerWith(varName);
        }
    })));
