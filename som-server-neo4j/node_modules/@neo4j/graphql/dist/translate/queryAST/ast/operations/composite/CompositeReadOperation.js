...
class CompositeReadOperation extends operations_1.Operation {
    ...
    transpileTopLevelCompositeRead(context) {
        ...
        const nestedSubquery = new cypher_builder_1.default.Call(new cypher_builder_1.default.Union(...nestedSubqueries)).return(context.returnVariable);
    ...
    transpile({ context }) {
        ...
        let aggrExpr = cypher_builder_1.default.collect(context.returnVariable);
        if (this.relationship && !this.relationship.isList) {
            aggrExpr = cypher_builder_1.default.head(aggrExpr);
        }
        const nestedSubquery = new cypher_builder_1.default.Call(new cypher_builder_1.default.Union(...nestedSubqueries)).with(context.returnVariable);
        if (this.sortFields.length > 0) {
            nestedSubquery.orderBy(...this.getSortFields(context, context.returnVariable));
        }
        if (this.pagination) {
