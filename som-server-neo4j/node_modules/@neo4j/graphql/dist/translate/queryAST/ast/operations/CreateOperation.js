 ...
 **/
class CreateOperation extends operations_1.Operation {
    constructor({ target }) {
        super();
    ...
    getChildren() {
        return (0, utils_1.filterTruthy)(this.projectionOperations);
    }
    ...
    getProjectionClause({ context }) {
        return this.projectionOperations.map((operationField) => {
            return cypher_builder_1.default.concat(...operationField.transpile({ context }).clauses);
        });
    }
}
