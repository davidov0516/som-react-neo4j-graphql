...
class QueryAST {
    ...
    build(neo4jGraphQLContext) {
        const context = this.buildQueryASTContext(neo4jGraphQLContext);
        return cypher_builder_1.default.concat(...this.transpile(context).clauses);
    }
    /**
    ...
    buildQueryASTContext(neo4jGraphQLContext) {
        const queryASTEnv = new QueryASTContext_1.QueryASTEnv();
        const returnVariable = new cypher_builder_1.default.NamedVariable("this");
    ...
    getTargetFromOperation(neo4jGraphQLContext) {
        if (this.operation instanceof ReadOperation_1.ReadOperation || this.operation instanceof ConnectionReadOperation_1.ConnectionReadOperation) {
            return (0, create_node_from_entity_1.createNodeFromEntity)(this.operation.target, neo4jGraphQLContext, this.operation.nodeAlias);
        }
    }
    print() {
