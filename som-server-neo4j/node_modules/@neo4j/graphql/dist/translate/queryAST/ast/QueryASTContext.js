...
class QueryASTContext {
    constructor({ target, relationship, source, env, neo4jGraphQLContext, returnVariable, shouldCollect, }) {
        this.target = target;
        this.relationship = relationship;
        this.source = source;
        this.env = env ?? new QueryASTEnv();
        this.neo4jGraphQLContext = neo4jGraphQLContext;
        this.returnVariable = returnVariable ?? new cypher_builder_1.default.Variable();
    ...
    push({ relationship, target, returnVariable, }) {
