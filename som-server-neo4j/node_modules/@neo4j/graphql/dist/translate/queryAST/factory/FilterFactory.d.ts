...
export declare class FilterFactory {
    ...
    createConnectionFilter(relationship: RelationshipAdapter, where: ConnectionWhereArg, filterOps: {
        isNot: boolean;
    ...
    protected createPropertyFilter({ attribute, comparisonValue, operator, isNot, attachedTo, }: {
    ...
    createNodeFilters(entity: EntityAdapter, where: Record<string, unknown>): Filter[];
