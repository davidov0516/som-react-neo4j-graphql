...
export declare class SortAndPaginationFactory {
    createSortFields(options: GraphQLOptionsArg, entity: ConcreteEntityAdapter | RelationshipAdapter | InterfaceEntityAdapter | UnionEntityAdapter): Sort[];
    createConnectionSortFields(options: ConnectionSortArg, entityOrRel: ConcreteEntityAdapter | RelationshipAdapter): {
        edge: Sort[];
        node: Sort[];
    };
