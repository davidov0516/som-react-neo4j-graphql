...
function findResolver({ node, entityAdapter }) {
    ...
    const optionsArgumentType = entityAdapter instanceof UnionEntityAdapter_1.UnionEntityAdapter ? QueryOptions_1.QueryOptions : entityAdapter.operations.optionsInputTypeName;
    return {
