...
function makeAugmentedSchema({ document, features, userCustomResolvers, subgraph, schemaModel, experimental, }) {
...
function doForInterfacesThatAreTargetOfARelationship({ composer, interfaceEntityAdapter, features, subgraph, relationships, relationshipFields, userDefinedFieldDirectivesForNode, propagatedDirectivesForNode, experimental, }) {
