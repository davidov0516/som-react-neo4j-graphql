...
export declare function withWhereInputType({ entityAdapter, userDefinedFieldDirectives, features, composer, }: {
    entityAdapter: EntityAdapter | RelationshipAdapter;
    userDefinedFieldDirectives: Map<string, DirectiveNode[]>;
    features: Neo4jFeaturesSettings | undefined;
    composer: SchemaComposer;
}): InputTypeComposer;
export declare function withSourceWhereInputType({ relationshipAdapter, composer, deprecatedDirectives, }: {
    relationshipAdapter: RelationshipAdapter;
    composer: SchemaComposer;
    deprecatedDirectives: Directive[];
}): InputTypeComposer | undefined;
export declare function makeConnectionWhereInputType({ relationshipAdapter, memberEntity, composer, }: {
    relationshipAdapter: RelationshipAdapter;
